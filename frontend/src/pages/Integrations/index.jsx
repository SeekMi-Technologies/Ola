...
import { Button, Input, Switch, Row, Col, Tag, message } from 'antd';
...
export default function IntegrationsPage() {
  ...
  const INITIAL_INTEGRATIONS = useMemo(() => [
    {
      id: 'google_ads',
      name: 'Google Ads',
      connected: true,
      popular: true,
      description: translate('integration_desc_google_ads'),
      logo: (
    ...
    },
    {
      ...
      connected: true,
      popular: true,
      description: translate('integration_desc_linear'),
      logo: (
    ...
    },
    {
      ...
      connected: false,
      popular: true,
      description: translate('integration_desc_notion'),
      logo: (
        <svg viewBox="0 0 24 24" width="22" height="22" fill="#000000">
    ...
    },
    {
      ...
      connected: false,
      popular: false,
      description: translate('integration_desc_apollo'),
      logo: (
        <svg viewBox="0 0 24 24" width="22" height="22">
    ...
    },
    {
      ...
      connected: false,
      popular: false,
      description: translate('integration_desc_sentry'),
      logo: (
    ...
    },
    {
      ...
      connected: false,
      popular: true,
      description: translate('integration_desc_vercel'),
      logo: (
        <svg viewBox="0 0 24 24" width="22" height="22" fill="#000000">
    ...
    },
    {
      ...
      connected: false,
      popular: true,
      description: translate('integration_desc_whatsapp'),
      logo: (
        <svg viewBox="0 0 24 24" width="22" height="22">
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          ...
          >
            {translate('popular_integrations')}
          </button>
        </div>
      ...
      <Row gutter={[24, 24]}>
        {filteredIntegrations.map((item) => (
          <Col xs={24} sm={12} md={8} key={item.id}>
            <div
              className={`whiteBox shadow integration-card${item.connected ? ' integration-card--connected' : ''}`}
