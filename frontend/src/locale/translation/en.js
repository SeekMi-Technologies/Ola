const lang = {
  ...
  complete_workspace: 'Complete Workspace',
  ...
  integrations_subtitle: 'Connect the tools you use and let OLA perform tasks across various apps.',
  add_custom_mcp: 'Add Custom MCP',
  all_integrations: 'All integrations',
  popular_integrations: 'Popular integrations',
  show_connected_only: 'Show connected only',
  connected: 'Connected',
  connect: 'Connect',
  no_integrations_found: 'No integrations found matching your criteria.',
  integration_connected: 'connected successfully!',
  integration_disconnected: 'disconnected successfully.',
  custom_mcp_coming_soon: 'Custom MCP integration server configurations coming soon!',
  integration_desc_google_ads: 'Sync leads and conversions to Google Ads.',
  integration_desc_linear: 'Manage dev tasks and workflows.',
  integration_desc_notion: 'Sync CRM data with Notion pages.',
  integration_desc_apollo: 'Find leads and automate outreach.',
  ...
  notion_nickname_required: 'Please enter a nickname for this account',
  notion_connected_success: 'Notion integration connected successfully!',
  notion_disconnected_success: 'Notion integration disconnected successfully!',
  Main: 'Main',
  Business: 'Business',
  Finance: 'Finance',
  Personal: 'Personal',
